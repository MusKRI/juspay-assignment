...
export function CopyButton({ content, tooltip }: Props) {
  const duration = 0.4;
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          ...
          className="relative opacity-0 group-hover:opacity-100 cursor-pointer after:absolute after:-inset-2"
        >
          <motion.svg
            initial="idle"
            whileHover="hover"
